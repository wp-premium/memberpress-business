...
<div id="header" style="width: 680px; padding: 0px; margin: 0 auto; text-align: left;">
  <h1 style="font-size: 30px; margin-bottom: 0;"><?php _ex('Subscription Cancelled', 'ui', 'memberpress'); ?></h1>
...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div class="section" style="display: block; margin-bottom: 24px;"><?php _ex('A subscription was just cancelled on {$blog_name}:', 'ui', 'memberpress'); ?></div>
  <table style="clear: both;" class="transaction">
    ...
    <tr><th style="text-align: left;"><?php _ex('Auto Rebill:', 'ui', 'memberpress'); ?></th><td><?php _ex('Stopped', 'ui', 'memberpress'); ?></td></tr>
