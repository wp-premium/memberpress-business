...
<div id="header" style="width: 680px; padding: 0px; margin: 0 auto; text-align: left;">
  <h1 style="font-size: 30px; margin-bottom: 0;"><?php _ex('Subscription Upgraded', 'ui', 'memberpress'); ?></h1>
...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div class="section" style="display: block; margin-bottom: 24px;"><?php _ex('A user upgraded their subscription on {$blog_name}:', 'ui', 'memberpress'); ?></div>
